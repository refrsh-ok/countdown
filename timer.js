// Set the date we're counting down to
        ...
        var countDownDate = new Date("October 27, " + currentYear + " 12:00:00 AM GMT+1 (CET)").getTime();
        ...
        var x = setInterval(function() {
            ...
            if (countDownDate < now) {
              ...
              countDownDate = new Date("October 27, " + currentYear + " 12:00:00 AM GMT+1 (CET)").getTime();
            }
